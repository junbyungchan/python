...
P(A|B) : 사건 B가 일어 났을 때, 사건 A가 일어날 (조건부) 확률
    P(A|B) = P(A,B) / P(B)
...
C : 두 자녀중 최소 한명이 딸인 경우 P(C) = 3/4
P(A,B) = 1/4
P(B,C) = 2/4 = 1/2
P(B|A) = P(첫째가 딸일 때 두 자녀 모두 딸일 확률) = 1/2
       = P(B,A)/P(A) = 0.25/0.5 = 0.5
P(B|A) = P(첫째가 딸일 때, 두 자녀 모두 딸) = 1/2
       = P(C,A) / /P(A) = (1/4) / (2/4) = 1/2
P(B|C) = P(적어도 한 명이 딸일 때, 두 자녀 모두 딸이 확률) = 1/3
...
either_girl = 0 # 두 다녀 중 적어도 한 명이 딸인 경우
...
print('P(적어도 한명이 딸일 때, 두자녀 모두 딸) =',p2)
